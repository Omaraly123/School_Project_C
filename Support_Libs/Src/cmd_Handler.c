...
static COORD staticcConsoleCoordinatorHandler;
...
void cmdSaveXY(void)
{
	HANDLE hConsoleHandler;
	hConsoleHandler = GetStdHandle(STD_OUTPUT_HANDLE);
	staticcConsoleCoordinatorHandler = GetConsoleCursorPosition(hConsoleHandler);
}

void cmdRestoreXY(void)
{
	HANDLE hConsoleHandler;	
	hConsoleHandler = GetStdHandle(STD_OUTPUT_HANDLE);
	SetConsoleCursorPosition(hConsoleHandler, staticcConsoleCoordinatorHandler);
}
